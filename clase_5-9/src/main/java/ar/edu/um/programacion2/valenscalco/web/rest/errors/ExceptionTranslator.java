package ar.edu.um.programacion2.valenscalco.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof ar.edu.um.programacion2.valenscalco.service.EmailAlreadyUsedException ||
            ex instanceof ar.edu.um.programacion2.valenscalco.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof ar.edu.um.programacion2.valenscalco.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(
            ...
            "io.",
            "de.",
            "ar.edu.um.programacion2.valenscalco"
        );
    }
}
